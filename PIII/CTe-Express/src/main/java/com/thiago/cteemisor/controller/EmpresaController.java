...
import com.thiago.cteemisor.entity.Empresa;
import com.thiago.cteemisor.service.EmpresaService;

@CrossOrigin(origins = "http://localhost:8080") // Permite requisições desse endereço
@RestController
